...
const Footer = () => {
  ...
  return (
    <footer className="bg-primary max-w-[1600px] max-sm:pb-16 mx-auto w-full">
      <div className="w-full grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 items-center gap-4">
        <div className="col-span-3 w-full">
          <div className="w-full relative lg:aspect-[4/3.2] aspect-[4/5]">
            <Image
        ...
        <div className="lg:col-span-2 max-width col-span-2 flex flex-col h-full justify-center gap-6 lg:px-6 w-full uppercase">
